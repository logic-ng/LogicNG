...
public interface AdvancedModelEnumerationStrategy {
     ...
     * @param recursionDepth the recursion depth starting with 0, the first recursive call has depth 1
    ...
    /**
     * Reduces the split variables for the given recursion depth.
