...
public final class BDDDNFTransformation extends BDDNormalFormTransformation {
    ...
    /**
     * Constructs a new BDD-based DNF transformation with an optional BDD
     * kernel.
     * <p>
    ...
    /**
     * Constructs a new BDD-based DNF transformation for a given number of
     * variables.
     * <p>
     * Warning: You can use this object for arbitrarily many transformations,
     * <b>but</b> the number of different variables in all applied formulas
     ...
     * {@link #BDDDNFTransformation(BDDKernel)}, where you have full control
    ...
    /**
     * Constructs a new BDD-based DNF transformation and constructs a new BDD
