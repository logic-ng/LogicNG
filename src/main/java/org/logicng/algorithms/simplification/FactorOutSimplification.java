 ...
 * @since 2.0.0
 */
public class FactorOutSimplification implements FormulaTransformation {
     ...
     */
    public FactorOutSimplification(final RatingFunction<? extends Number> ratingFunction) {
     ...
     */
    public FactorOutSimplification() {
