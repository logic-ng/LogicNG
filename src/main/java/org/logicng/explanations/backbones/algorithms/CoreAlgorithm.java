...
/**
 * An iterative Backbone algorithm that uses cores to distinguish Backbone literals.
 * @version 1.5
 * @since 1.5
 */
public class CoreAlgorithm implements BackboneAlgorithm {
