...
public class FormulaAstGraphicalGeneratorTest {
    ...
    public void testFixedStyle() throws ParserException, IOException {
        ...
        final FormulaAstGraphicalGenerator translator = FormulaAstGraphicalGenerator.builder()
    ...
    private void testFiles(final String fileName, final Formula formula, final FormulaAstGraphicalGenerator translator) throws IOException {
        testFiles(fileName, formula, translator, null);
    }

    private void testFiles(final String fileName, final Formula formula, final FormulaAstGraphicalGenerator translator, final NodeStyleMapper<Formula> mapper) throws IOException {
