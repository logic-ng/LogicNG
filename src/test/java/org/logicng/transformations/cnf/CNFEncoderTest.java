...
public class CNFEncoderTest {
    ...
    public void testFactorization() throws ParserException {
        ...
        assertThat(phi1.cnf()).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        ...
        assertThat(phi1.cnf()).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        final CNFEncoder encoder =
                new CNFEncoder(f, CNFConfig.builder().algorithm(CNFConfig.Algorithm.FACTORIZATION).build());
        assertThat(encoder.encode(phi1)).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
    }
    ...
    public void testTseitin() throws ParserException {
        ...
        assertThat(phi1.cnf()).isEqualTo(p.parse(
        ...
        assertThat(phi2.cnf()).isEqualTo(
                p.parse("(y1 | y2) & y3 & y4 & (y1 | y8 | y9) & (y5 | y8 | y9) & (~y6 | y8 | y9) & (~y7 | y8 | y9)"));
    }
    ...
    public void testAdvanced() throws ParserException {
        ...
        assertThat(phi2.cnf()).isEqualTo(p.parse(
        ...
        assertThat(phi3.cnf()).isEqualTo(p.parse(
    ...
    public void testAdvancedWithPGFallback() throws ParserException {
        ...
        assertThat(phi1.cnf()).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        f.putConfiguration(CNFConfig.builder().createdClauseBoundary(5).atomBoundary(3)
        ...
        f.putConfiguration(CNFConfig.builder().createdClauseBoundary(-1).distributionBoundary(5).atomBoundary(3)
                .fallbackAlgorithmForAdvancedEncoding(CNFConfig.Algorithm.PLAISTED_GREENBAUM).build());
        assertThat(phi3.cnf()).isEqualTo(p.parse(
    ...
    public void testTseitinEncoder() throws ParserException {
        ...
        final PropositionalParser p = new PropositionalParser(f);
        final Formula phi1 = p.parse(p1);
        final CNFEncoder encoder1 =
                new CNFEncoder(f, CNFConfig.builder().algorithm(CNFConfig.Algorithm.TSEITIN).build());
        assertThat(encoder1.encode(phi1)).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        final CNFEncoder encoder2 =
                new CNFEncoder(f, CNFConfig.builder().algorithm(CNFConfig.Algorithm.TSEITIN).atomBoundary(8).build());
        assertThat(encoder2.encode(phi1)).isEqualTo(p.parse(
                "(@RESERVED_CNF_0 | ~x1) & (@RESERVED_CNF_0 | ~x2) & (~@RESERVED_CNF_0 | x1 | x2) & (~@RESERVED_CNF_1 | x1) & (~@RESERVED_CNF_1 | x5) & (~@RESERVED_CNF_1 | ~x6) & (~@RESERVED_CNF_1 | ~x7) & (@RESERVED_CNF_1 | ~x1 | ~x5 | x6 | x7) & (@RESERVED_CNF_2 | ~@RESERVED_CNF_1) & (@RESERVED_CNF_2 | ~x8) & (@RESERVED_CNF_2 | ~x9) & (~@RESERVED_CNF_2 | @RESERVED_CNF_1 | x8 | x9) & @RESERVED_CNF_0 & x3 & x4 & @RESERVED_CNF_2"));
    }
    ...
    public void testPGEncoder() throws ParserException {
        ...
        final Formula phi1 = p.parse(p1);
        final CNFEncoder encoder1 =
                new CNFEncoder(f, CNFConfig.builder().algorithm(CNFConfig.Algorithm.PLAISTED_GREENBAUM).build());
        assertThat(encoder1.encode(phi1)).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        final CNFEncoder encoder2 = new CNFEncoder(f,
                CNFConfig.builder().algorithm(CNFConfig.Algorithm.PLAISTED_GREENBAUM).atomBoundary(8).build());
        assertThat(encoder2.encode(phi1)).isEqualTo(p.parse(
                "@RESERVED_CNF_1 & x3 & x4 & @RESERVED_CNF_2 & (~@RESERVED_CNF_1 | x1 | x2) & (~@RESERVED_CNF_2 | @RESERVED_CNF_3 | x8 | x9) & (~@RESERVED_CNF_3 | x1) & (~@RESERVED_CNF_3 | x5) & (~@RESERVED_CNF_3 | ~x6) & (~@RESERVED_CNF_3 | ~x7)"));
    }
    ...
    public void testAdvancedEncoder() throws ParserException {
        ...
        assertThat(encoder1.encode(phi1)).isEqualTo(
                p.parse("(x1 | x2) & x3 & x4 & (x1 | x8 | x9) & (x5 | x8 | x9) & (~x6 | x8 | x9) & (~x7 | x8 | x9)"));
        final CNFEncoder encoder2 =
                new CNFEncoder(f, CNFConfig.builder().createdClauseBoundary(5).atomBoundary(3).build());
        assertThat(encoder2.encode(phi2)).isEqualTo(p.parse(
                "(y1 | y2) & y3 & y4 & (~@RESERVED_CNF_0 | y1) & (~@RESERVED_CNF_0 | y5) & (~@RESERVED_CNF_0 | ~y6) & (~@RESERVED_CNF_0 | ~y7) & (@RESERVED_CNF_0 | ~y1 | ~y5 | y6 | y7) & (@RESERVED_CNF_0 | y8 | y9)"));
        final CNFEncoder encoder3 = new CNFEncoder(f,
                CNFConfig.builder().createdClauseBoundary(-1).distributionBoundary(5).atomBoundary(3).build());
        assertThat(encoder3.encode(phi3)).isEqualTo(p.parse(
                "(z1 | z2) & z3 & z4 & (~@RESERVED_CNF_2 | z1) & (~@RESERVED_CNF_2 | z5) & (~@RESERVED_CNF_2 | ~z6) & (~@RESERVED_CNF_2 | ~z7) & (@RESERVED_CNF_2 | ~z1 | ~z5 | z6 | z7) & (@RESERVED_CNF_2 | z8 | z9)"));
    }
