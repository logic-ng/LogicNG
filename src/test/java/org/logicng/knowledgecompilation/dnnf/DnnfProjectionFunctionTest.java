...
public class DnnfProjectionFunctionTest {
    ...
    public void test() throws ParserException {
        ...
        final Formula formula = p.parse("((A1 | ~A2 & A3) & (~B1 & B2 | ~B3 | B4) | (~A1 | A2 | A4 & ~A5) & B1) " +
        ...
        assertThat(elimA1).isEqualTo(new Dnnf(elimA1Vars, p.parse("(~B1 & B2 | ~B3 | B4 | B1) " +
                                                                  "& ((C1 & C2 | ~C1 & C3 | C4) & (D1 | D2 | D3) | (~C1 | ~C2) & (D1 | D2 & D3))")));
        ...
        assertThat(elimA2C1).isEqualTo(new Dnnf(elimA2C1Vars, p.parse("((A1 | A3) & (~B1 & B2 | ~B3 | B4) | B1) " +
        ...
        assertThat(elimA3B3C4D2).isEqualTo(new Dnnf(elimA3B3C4D2Vars, p.parse("((A1 | ~A2) | (~A1 | A2 | A4 & ~A5) & B1)")));
    }
}
