...
public class FormulaRandomizerTest {
    ...
    public void testDeterminism() {
        final Formula expected =
                new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().seed(42).build()).formula(3);
        assertThat(new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().seed(42).build()).formula(3))
                .isEqualTo(expected);
        assertThat(new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().seed(43).build()).formula(3))
                .isNotEqualTo(expected);
        assertThat(new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().build()).formula(3))
                .isNotEqualTo(expected);
    ...
    public void testVariable() {
        ...
        final FormulaRandomizer random =
                new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().variables(vars).seed(42).build());
        int numA = 0;
        int numB = 0;
        int numC = 0;
        for (int i = 0; i < 100; i++) {
    ...
    public void testAtom() {
        ...
        final FormulaRandomizer randomOnlyLiterals = new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder()
    ...
    public void testAnd() {
        final FormulaRandomizer random =
                new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().seed(42).build());
        for (int i = 0; i < 10; i++) {
    ...
    public void testMaximumOperandsAnd() {
        final FormulaRandomizer random = new FormulaRandomizer(this.f,
                FormulaRandomizerConfig.builder().maximumOperandsAnd(10).seed(42).build());
        for (int i = 0; i < 100; i++) {
    ...
    public void testMaximumOperandsOr() {
        final FormulaRandomizer random =
                new FormulaRandomizer(this.f, FormulaRandomizerConfig.builder().maximumOperandsOr(10).seed(42).build());
        for (int i = 0; i < 100; i++) {
    ...
    public void testMaximumOperandsPbc() {
        final FormulaRandomizer random = new FormulaRandomizer(this.f,
                FormulaRandomizerConfig.builder().maximumOperandsPbc(10).seed(42).build());
        for (int i = 0; i < 100; i++) {
            final Formula formula = random.pbc();
