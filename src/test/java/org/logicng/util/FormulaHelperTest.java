...
public class FormulaHelperTest extends TestWithExampleFormulas {
    ...
    public void testVariables() {
        ...
        assertThat(FormulaHelper.variables(this.IMP1, this.IMP2, this.IMP3))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.X, this.Y)));
        assertThat(FormulaHelper.variables(this.IMP1, this.Y))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.Y)));

        assertThat(FormulaHelper.variables(Arrays.asList(this.TRUE, this.FALSE))).isEqualTo(new TreeSet<>());
        assertThat(FormulaHelper.variables(Arrays.asList(this.IMP1, this.IMP2, this.IMP3)))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.X, this.Y)));
        assertThat(FormulaHelper.variables(Arrays.asList(this.IMP1, this.Y)))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.Y)));
    }
    ...
    public void testLiterals() {
        ...
        assertThat(FormulaHelper.literals(this.IMP1, this.IMP2, this.IMP3))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.X, this.Y, this.NA, this.NB)));
        assertThat(FormulaHelper.literals(this.IMP1, this.NY))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.NY)));

        assertThat(FormulaHelper.literals(Arrays.asList(this.TRUE, this.FALSE))).isEqualTo(new TreeSet<>());
        assertThat(FormulaHelper.literals(Arrays.asList(this.IMP1, this.IMP2, this.IMP3)))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.X, this.Y, this.NA,
                        this.NB)));
        assertThat(FormulaHelper.literals(Arrays.asList(this.IMP1, this.NY)))
                .isEqualTo(new TreeSet<>(Arrays.asList(this.A, this.B, this.NY)));
    }
    ...
    public void testNegate() {
        assertThat((ArrayList<Formula>) FormulaHelper.negate(Collections.emptyList(), ArrayList::new))
                .isEqualTo(new ArrayList<Formula>());
        assertThat((ArrayList<Formula>) FormulaHelper.negate(Arrays.asList(this.A, this.TRUE, this.NB, this.AND1),
                ArrayList::new))
                        .isEqualTo(Arrays.asList(this.NA, this.FALSE, this.B, this.f.not(this.AND1)));
        assertThat((HashSet<Formula>) FormulaHelper.negate(Arrays.asList(this.A, this.TRUE, this.NB, this.AND1),
                HashSet::new))
