...
package org.logicng.formulas.clearCacheFormulaFactory.transformations.qe;
...
import org.logicng.transformations.qe.ExistentialQuantifierElimination;
import org.logicng.transformations.qe.UniversalQuantifierElimination;
 ...
 * @since 1.0
 */
public class QECCFTest {

  private final ClearCacheFormulaFactory f = new ClearCacheFormulaFactory();
