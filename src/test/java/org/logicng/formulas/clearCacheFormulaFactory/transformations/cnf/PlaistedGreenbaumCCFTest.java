...
package org.logicng.formulas.clearCacheFormulaFactory.transformations.cnf;
...
import org.logicng.formulas.clearCacheFormulaFactory.CCF;
 ...
 * @since 1.2
 */
public class PlaistedGreenbaumCCFTest {

  private static CCF F = new CCF();
  ...
  public void testSaveState() throws ParserException {
    ClearCacheFormulaFactory f = new ClearCacheFormulaFactory();
