 ...
 * @since 1.2
 */
public class PBConstraintCCFTest {

  private static final ClearCacheFormulaFactory f = new ClearCacheFormulaFactory();
  private static final ClearCacheFormulaFactory f2 = new ClearCacheFormulaFactory();
