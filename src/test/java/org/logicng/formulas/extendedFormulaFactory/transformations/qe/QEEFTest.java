...
package org.logicng.formulas.extendedFormulaFactory.transformations.qe;
 ...
 * @since 1.0
 */
public class QEEFTest {

  private final ExtendedFormulaFactory f = new ExtendedFormulaFactory();
