 ...
 * @since 1.2
 */
public class PBConstraintEFTest {

  private static final ExtendedFormulaFactory f = new ExtendedFormulaFactory();
  private static final ExtendedFormulaFactory f2 = new ExtendedFormulaFactory();
