...
public class PrimeResultTest {
    ...
    public PrimeResultTest() {
        ...
        primeImplicants1.add(new TreeSet<>(Arrays.asList(F.A, F.NB)));
        primeImplicants1.add(new TreeSet<>(Arrays.asList(F.A, F.C)));
        final List<SortedSet<Literal>> primeImplicates1 = new ArrayList<>();
        primeImplicates1.add(new TreeSet<>(Arrays.asList(F.A, F.NB)));
        ...
        primeImplicants2.add(new TreeSet<>(Arrays.asList(F.A, F.NB)));
        primeImplicants2.add(new TreeSet<>(Collections.singletonList(F.C)));
        ...
        primeImplicates3.add(new TreeSet<>(Collections.singletonList(F.NB)));
    ...
    public void testGetters() {
        ...
        assertThat(this.result1.getPrimeImplicants().get(0)).containsExactly(F.A, F.NB);
        assertThat(this.result1.getPrimeImplicants().get(1)).containsExactly(F.A, F.C);
        assertThat(this.result2.getPrimeImplicants()).hasSize(2);
        assertThat(this.result2.getPrimeImplicants().get(0)).containsExactly(F.A, F.NB);
        assertThat(this.result2.getPrimeImplicants().get(1)).containsExactly(F.C);
        ...
        assertThat(this.result1.getPrimeImplicates().get(0)).containsExactly(F.A, F.NB);
        assertThat(this.result2.getPrimeImplicates()).hasSize(0);
        assertThat(this.result3.getPrimeImplicates()).hasSize(1);
        assertThat(this.result3.getPrimeImplicates().get(0)).containsExactly(F.NB);
