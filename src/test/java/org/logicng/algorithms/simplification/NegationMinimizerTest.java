...
/**
 * Unit tests for the class {@link NegationMinimizer}.
 * @version 2.0.0
 * @since 2.0.0
 */
public class NegationMinimizerTest {
    ...
    private final NegationMinimizer minimizer = new NegationMinimizer();
    ...
    private static void computeAndVerify(final Formula formula) {
        ...
        final Formula simplified = formula.transform(new NegationMinimizer());
